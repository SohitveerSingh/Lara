...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   do {
    ...
    // add new user to database
        ...
        if($connection->prepare("SELECT * FROM userdata WHERE  username = ?"))
        {
        $fetching_user = $connection->prepare("SELECT * FROM userdata WHERE  username = ?");
        $fetching_user->bind_param('s', $username);
                  ...
                  <div class="col-lg-6">
                    <div class="d-flex flex-column h-100">
                      ...
                      <div class="p-4 my-auto ">
                        ...
                        <p class="text-muted mb-3">Enter your username and password to access account.</p>
