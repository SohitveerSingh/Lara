            ...
            <div class="content-page">
                <div class="content" id="TableCon">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="card">
                                <div class="card-header" id="cardHeadDesign" >
                                    <h4 class="header-title" id="tableTitle">Transfer Funds</h4>
                                    <div id="WalletDesign" >
                                        <div>Balance:&nbsp;</div>
                                        <div>64$</div>
                                                    ...
                                                    <div id="formDesign">
                                                        <div class="col-lg-5 ">
                                                            ...
                                                            <div class="mb-3 row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input placeholder="Min 10$" min="10" max="500" type="number"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-3 row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input placeholder="Confirm Amount" type="email"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
