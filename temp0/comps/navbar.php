...
<div class="">
    <a class="logo logo-light" href="#">
        <span class="logo-lg"><img
                ...
                alt="small logo"></span></a><a href="https://themes.techzaa.in/velonic_r/index.html"
...
';
    ...
    echo '
    <li class="side-nav-item ">
        <a class="side-nav-link-ref side-nav-link" data-menu-key="dashboard" href="./login.php">
            <i class="ri-dashboard-3-line"></i>
            <span>Login</span>
        </a>
    </li>
...
';
    ...
    echo '
    <li class="side-nav-item ">
        <a class="side-nav-link-ref side-nav-link" data-menu-key="dashboard" href=".signup.php">
            <i class="ri-dashboard-3-line"></i>
            <span>Register</span>
        </a>
    </li>
...
<?php echo '
              ...
              <li class="side-nav-item" onclick="toggleBonus()">
                ...
                <div class="collapse" id="collapseBonus">
                  <ul class="side-nav-second-level">
                    <li class="side-nav-item">
                      <a href="./directBonus.php" class="side-nav-link-ref" data-menu-key="pages-Starter"><span> Direct
                          Bonus</span></a>
                    </li>
                    <li class="side-nav-item">
...
';
    ...
    echo '
    <li class="side-nav-item ">
        <a class="side-nav-link-ref side-nav-link" data-menu-key="dashboard" href="./controllers/auth/logout.php">
            <i class="ri-dashboard-3-line"></i>
            <span>Logout</span>
        </a>
    </li>
